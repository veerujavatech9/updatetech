...
<div id="page-wrapper">
	<div class="container-fluid">
			...
			<div class="col-lg-5 col-md-6">
				...
				<div class="input-group date" id="date-picker">
					<input type="text" class="form-control" id="postDate"
						name="postDate" value="${selectedDate}" onchange="dashboardFunction()" />
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-6">
				<div class="panel panel-blue">
					<div class="panel-heading">
						<a href="${pageContext.request.contextPath}/scannedUsers">
							<div class="row">
								<div class="col-xs-3">
									<i class="fa fa-mobile fa-5x"></i>
								</div>
								<div class="col-xs-9 text-right">
									<div class="huge">${sessionScope['scopedTarget.sessionObj'].scanningUsersCount}</div>
									<div>Scanning Users</div>
								</div>
							</div>
						</a>
					</div>
			...
			<div class="col-lg-3 col-md-6">
				<a href="${pageContext.request.contextPath}/scannedJobs">
					<div class="panel panel-green">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge">${sessionScope['scopedTarget.sessionObj'].activeJobsCount}</div>
									<div>Active Jobs</div>
								</div>
							</div>
						</div>
			...
			<div class="col-lg-3 col-md-6">
				<a href="${pageContext.request.contextPath}/scannedEmps">
					<div class="panel panel-purple">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge">${sessionScope['scopedTarget.sessionObj'].activeEmployeesCount}</div>
			...
			<div class="col-lg-3 col-md-6">
				<a href="${pageContext.request.contextPath}/scannedIdleEmps">
					<div class="panel panel-yellow">
						<div class="panel-heading">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge">${sessionScope['scopedTarget.sessionObj'].idleEmployeesCount}</div>
									<div>Idle Employees</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="remove-button">
								<a href="${pageContext.request.contextPath}/remove_Duplicates" class="btn btn-info" role="button">Remove Duplicate</a>
							</div>
						</div>
					</div>
					<!-- /.panel-heading -->
										...
										<thead>
											<tr role="row" class="bg-warning">
												...
												<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Project Name: activate to sort column ascending"
													style="width: 148px;">Scanned/Manual</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach var="actions" items="${todaysActions}"
												...
												<tr class="gradeA odd " role="row">
													...
													<td><c:choose>
															<c:when test="${actions.scanned eq true}"> Scanned </c:when>
...
<script type="text/javascript">
	...
	function dashboardFunction() {
		...
		window.location.href = "${pageContext.request.contextPath}/admin_Dashboard_Date?postDate="
				+ postDate;
	}
</script>
