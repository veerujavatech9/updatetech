	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12"
				...
				<h3 class="page-header">Work Stations List</h3>
				<div class="col-sm-12">
					<table width="100%"
						...
						<tbody>
							<c:forEach var="activity" items="${activityList}"
								...
								<tr class="gradeA odd " role="row">
									...
									<td><c:choose>
											<c:when test="${activity.status eq true}"> Active</c:when>
											<c:otherwise>In-Active</c:otherwise>
										</c:choose></td>
									<%-- <td class="center"><a
										href="${pageContext.request.contextPath}/jobActivity/editWorkStation/${activity.id}"
										class="btn btn-xs btn-warning"><i class="fa fa-edit fa-fw"></i></a></td>
									<td class="center"><button class="btn btn-xs btn-danger"
											onclick="if(confirm('Are you sure you want to Delete this Work Station?')) window.location.href = '${pageContext.request.contextPath}/jobActivity/deleteWorkStation/${activity.id}';">
